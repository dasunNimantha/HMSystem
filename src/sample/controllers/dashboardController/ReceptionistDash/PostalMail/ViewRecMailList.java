...
public class ViewRecMailList {
    ...
    public void initialize() throws IOException {
        ArrayList<PostalMail> mailArrayList = PostalMail.viewMail("Received");
                ...
                public void updateItem(String item,boolean empty){
                    ...
                    if(empty){
                        ...
                        viewMail.setOnAction(event -> {
                            ViewRecMail.selectedMail= getTableView().getItems().get(getIndex());
                            BorderPane parentBorderPane = (BorderPane) (mailListAnchor.getParent());
                            try {
                                Parent viewComplain= FXMLLoader.load(getClass().getResource("../../../../views/dashboard/recepDash/PostalMail/viewReceivedMail.fxml"));
