...
public class ViewAppointController {
    ...
    void backFromViewAppo(ActionEvent event) throws IOException {
        Parent step2 = FXMLLoader.load(getClass().getResource("../../../views/dashboard/adminDash/Step3/Step3.fxml"));
        BorderPane subBorderPane = (BorderPane) viewAppointAnchor.getParent();
        subBorderPane.setCenter(step2);
    }

    @FXML
    void deleteAppo(ActionEvent event) throws IOException {
        Appointment.deleteAppointment("Admin",selectedAppointment.getAppointmentNo());
    }
